/**
 * marked - a markdown parser - v4.0.17
...
!(function (e, t) {
    ...
    if (
      ...
      (n = (function (e, t) {
        if (e) {
          ...
          return "Map" ===
            (u = "Object" === u && e.constructor ? e.constructor.name : u) ||
            "Set" === u
            ? Array.from(e)
            : "Arguments" === u ||
  ...
  function p(u, e) {
    ...
    var n = {
      replace: function (e, t) {
        return (
          (t = (t = t.source || t).replace(h, "$1")), (u = u.replace(e, t)), n
        );
      },
      getRegex: function () {
  ...
  var w = (function () {
      ...
      return (
            ...
            return (
              (u = (function (e, t) {
                ...
                return t
                  ...
                  .map(function (e) {
                    var t = e.match(/^\s+/);
                    return null !== t && t[0].length >= u.length
                      ? e.slice(u.length)
                      : e;
                  })
                  .join("\n");
              })((t = e[0]), e[3] || "")),
              { type: "code", raw: t, lang: e[2] && e[2].trim(), text: u }
            );
        }),
        (t.heading = function (e) {
          ...
          if (e)
            return (
              ...
              this.lexer.inline(u.text, u.tokens),
              u
            );
        }),
        (t.hr = function (e) {
        ...
        (t.list = function (e) {
          ...
          if (t) {
              ...
              if (
                ...
                for (
                  ...
                  this.options.pedantic &&
                    (a = a.replace(/^ {1,4}(?=( {4})*[^ ])/g, "  ")),
                  !C.test(a)) &&
                  !this.rules.block.heading.test(a) &&
                  !A.test(a) &&
                  !d.test(e);
            ...
            for (var k = f.items.length, E = 0; E < k; E++) {
              (this.lexer.state.top = !1),
                (f.items[E].tokens = this.lexer.blockTokens(
                  f.items[E].text,
                  []
                ));
              var x = f.items[E].tokens.filter(function (e) {
                  return "space" === e.type;
                }),
                m = x.every(function (e) {
          ...
          if (e) {
            ...
            if (t.header.length === t.align.length) {
              ...
              for (i = t.rows.length, s = 0; s < i; s++)
                t.rows[s] = C(t.rows[s], t.header.length).map(function (e) {
                  return { text: e };
                });
              for (i = t.header.length, u = 0; u < i; u++)
                (t.header[u].tokens = []),
                  this.lexer.inline(t.header[u].text, t.header[u].tokens);
              for (i = t.rows.length, u = 0; u < i; u++)
                for (r = t.rows[u], n = 0; n < r.length; n++)
                  (r[n].tokens = []), this.lexer.inline(r[n].text, r[n].tokens);
              return t;
            }
          }
        }),
        ...
        (t.text = function (e) {
          ...
          if (e)
            return (
              (e = { type: "text", raw: e[0], text: e[0], tokens: [] }),
              this.lexer.inline(e.text, e.tokens),
              e
            );
        }),
    ...
    v =
      ...
      (y.gfm.table = p(y.gfm.table)
        ...
        .replace("tag", y._tag)
        .getRegex()),
      (y.gfm.paragraph = p(y._paragraph)
        .replace("hr", y.hr)
        .replace("heading", " {0,3}#{1,6} ")
        .replace("|lheading", "")
      ...
      (y.pedantic = d({}, y.normal, {
        ...
        heading: /^(#{1,6})(.*)(?:\n+|$)/,
        fences: A,
        paragraph: p(y.normal._paragraph)
          .replace("hr", y.hr)
          .replace("heading", " *#{1,6} *[^\n]")
  ...
  (v._punctuation = "!\"#$%&'()+\\-.,/:;<=>?@\\[\\]`^{|}~"),
    (v.punctuation = p(v.punctuation)
      .replace(/punctuation/g, v._punctuation)
      .getRegex()),
    (v.blockSkip = /\[[^\]]*?\]\([^\)]*?\)|`[^`]*?`|<[^>]*?>/g),
    (v.escapedEmSt = /\\\*|\\_/g),
    (v._comment = p(y._comment).replace("(?:--\x3e|$)", "--\x3e").getRegex()),
    (v.emStrong.lDelim = p(v.emStrong.lDelim)
      .replace(/punct/g, v._punctuation)
      .getRegex()),
    (v.emStrong.rDelimAst = p(v.emStrong.rDelimAst, "g")
      .replace(/punct/g, v._punctuation)
      .getRegex()),
    (v.emStrong.rDelimUnd = p(v.emStrong.rDelimUnd, "g")
      .replace(/punct/g, v._punctuation)
      .getRegex()),
    (v._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g),
    ...
    (v.link = p(v.link)
      ...
      .getRegex()),
    (v.reflink = p(v.reflink)
      .replace("label", v._label)
      .replace("ref", y._label)
      .getRegex()),
    (v.nolink = p(v.nolink).replace("ref", y._label).getRegex()),
    (v.reflinkSearch = p(v.reflinkSearch, "g")
      .replace("reflink", v.reflink)
      .replace("nolink", v.nolink)
      .getRegex()),
    (v.normal = d({}, v)),
    (v.pedantic = d({}, v.normal, {
      strong: {
        start: /^__|\*\*/,
        middle:
  ...
  var z = (function () {
      function u(e) {
        ...
        this.options.pedantic
          ? ((e.block = y.pedantic), (e.inline = v.pedantic))
          : this.options.gfm &&
            ((e.block = y.gfm),
            this.options.breaks ? (e.inline = v.breaks) : (e.inline = v.gfm)),
            ...
            if (
              !(
                ...
                this.options.extensions.block.some(function (e) {
                  return (
                    !!(u = e.call({ lexer: s }, r, t)) &&
                    ((r = r.substring(u.raw.length)), t.push(u), !0)
                  );
                })
              )
            )
              if ((u = this.tokenizer.space(r)))
                ...
                (r = r.substring(u.raw.length)),
                  !(e = t[t.length - 1]) ||
                  ("paragraph" !== e.type && "text" !== e.type)
                    ? t.push(u)
                    : ((e.raw += "\n" + u.raw),
                      (e.text += "\n" + u.text),
                      (this.inlineQueue[this.inlineQueue.length - 1].src =
                        e.text));
              else if ((u = this.tokenizer.fences(r)))
                (r = r.substring(u.raw.length)), t.push(u);
              else if ((u = this.tokenizer.heading(r)))
                (r = r.substring(u.raw.length)), t.push(u);
              else if ((u = this.tokenizer.hr(r)))
                (r = r.substring(u.raw.length)), t.push(u);
              else if ((u = this.tokenizer.blockquote(r)))
                (r = r.substring(u.raw.length)), t.push(u);
              else if ((u = this.tokenizer.list(r)))
                (r = r.substring(u.raw.length)), t.push(u);
                ...
                (r = r.substring(u.raw.length)),
                  ...
                  ("paragraph" !== e.type && "text" !== e.type)
                    ...
                    : ((e.raw += "\n" + u.raw),
                      ...
                      (this.inlineQueue[this.inlineQueue.length - 1].src =
                        e.text));
              else if ((u = this.tokenizer.table(r)))
                (r = r.substring(u.raw.length)), t.push(u);
              else if ((u = this.tokenizer.lheading(r)))
                (r = r.substring(u.raw.length)), t.push(u);
              else if (
                ((i = r),
                this.options.extensions &&
        ...
        (n.inlineTokens = function (r, t) {
          ...
          if (this.tokens.links) {
            ...
            if (0 < D.length)
              for (
                ;
                null != (n = this.tokenizer.rules.inline.reflinkSearch.exec(o));

              )
                D.includes(n[0].slice(n[0].lastIndexOf("[") + 1, -1)) &&
                  (o =
                    o.slice(0, n.index) +
                    "[" +
                    m("a", n[0].length - 2) +
          ...
          for (; null != (n = this.tokenizer.rules.inline.blockSkip.exec(o)); )
            o =
              o.slice(0, n.index) +
              "[" +
              m("a", n[0].length - 2) +
          ...
          for (
            ;
            null != (n = this.tokenizer.rules.inline.escapedEmSt.exec(o));
          ...
          for (; r; )
            if (
              ...
              if ((u = this.tokenizer.escape(r)))
                (r = r.substring(u.raw.length)), t.push(u);
              else if ((u = this.tokenizer.tag(r)))
                (r = r.substring(u.raw.length)),
                  (e = t[t.length - 1]) &&
                  "text" === u.type &&
                  "text" === e.type
                    ? ((e.raw += u.raw), (e.text += u.text))
                    : t.push(u);
              else if ((u = this.tokenizer.link(r)))
                (r = r.substring(u.raw.length)), t.push(u);
                ...
                (r = r.substring(u.raw.length)),
                  ...
                  "text" === e.type
                    ? ((e.raw += u.raw), (e.text += u.text))
                    : t.push(u);
              else if ((u = this.tokenizer.emStrong(r, o, l)))
                (r = r.substring(u.raw.length)), t.push(u);
              else if ((u = this.tokenizer.codespan(r)))
                (r = r.substring(u.raw.length)), t.push(u);
              else if ((u = this.tokenizer.br(r)))
                (r = r.substring(u.raw.length)), t.push(u);
              else if ((u = this.tokenizer.del(r)))
                (r = r.substring(u.raw.length)), t.push(u);
              else if ((u = this.tokenizer.autolink(r, _)))
                (r = r.substring(u.raw.length)), t.push(u);
              else if (!this.state.inLink && (u = this.tokenizer.url(r, _)))
                (r = r.substring(u.raw.length)), t.push(u);
              else if (
                ((i = r),
                this.options.extensions &&
                ...
                (u = this.tokenizer.inlineText(i, j)))
              )
                (r = r.substring(u.raw.length)),
    ...
    $ = (function () {
      ...
      return (
        ...
        (t.link = function (e, t, u) {
          if (null === (e = g(this.options.sanitize, this.options.baseUrl, e)))
            return u;
          e = '<a href="' + D(e) + '"';
              ...
              switch (o.type) {
                ...
                case "heading":
                  d += this.renderer.heading(
                    ...
                    o.depth,
                    x(this.parseInline(o.tokens, this.textRenderer)),
                    this.slugger
                  );
                  continue;
                case "code":
                ...
                case "table":
                  ...
                  for (
                    ...
                    for (l = "", i = (s = o.rows[u]).length, n = 0; n < i; n++)
                      l += this.renderer.tablecell(
                        this.parseInline(s[n].tokens),
                        { header: !1, align: o.align[n] }
                      );
  ...
  function I(e, u, n) {
          ...
          "code" === u.type &&
            ...
            setTimeout(function () {
              i(u.text, u.lang, function (e, t) {
                if (e) return s(e);
                null != t && t !== u.text && ((u.text = t), (u.escaped = !0)),
                  0 === --l && s();
              });
            }, 0));
        }),
    ...
    try {
      ...
      if (
        ...
        return (
          "<p>An error occurred:</p><pre>" + D(e.message + "", !0) + "</pre>"
        );
      throw e;
    }
  }
  (I.options = I.setOptions =
    ...
    (I.use = function () {
      ...
      var n,
        ...
        o = I.defaults.extensions || { renderers: {}, childTokens: {} };
        ...
        if (
          (s.extensions &&
            ...
            s.extensions.forEach(function (r) {
              ...
              if (
                (r.renderer &&
                  ((i = o.renderers ? o.renderers[r.name] : null),
                ...
                o[r.level]
                  ? o[r.level].unshift(r.tokenizer)
                  : (o[r.level] = [r.tokenizer]),
                  r.start &&
                    ("block" === r.level
                      ? o.startBlock
                      ...
                      : "inline" === r.level &&
                        (o.startInline
                          ? o.startInline.push(r.start)
                          : (o.startInline = [r.start])));
              }
        ...
        !(function () {
          ...
          switch ((l.call(I, t), t.type)) {
            ...
            default:
              ...
              I.defaults.extensions.childTokens[t.type]
                ? I.defaults.extensions.childTokens[t.type].forEach(function (
                    e
                  ) {
                    I.walkTokens(t[e], l);
                  })
    ...
    (I.parseInline = function (e, t) {
      ...
      try {
        ...
        return (
          t.walkTokens && I.walkTokens(u, t.walkTokens), R.parseInline(u, t)
        );
      } catch (e) {
        if (
          ((e.message +=
